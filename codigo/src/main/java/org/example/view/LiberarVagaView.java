 ...
 * @author Joao
 */
public class LiberarVagaView extends javax.swing.JDialog {

    /**
     * Creates new form LiberarVaga
     */
    public LiberarVagaView(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LiberarVagaView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                LiberarVagaView dialog = new LiberarVagaView(new javax.swing.JFrame(), true);
