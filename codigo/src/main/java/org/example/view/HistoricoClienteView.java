 ...
 * @author Joao
 */
public class HistoricoClienteView extends javax.swing.JDialog {

    /**
     * Creates new form HistoricoCliente
     */
    public HistoricoClienteView(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                HistoricoClienteView dialog = new HistoricoClienteView(new javax.swing.JFrame(), true);
