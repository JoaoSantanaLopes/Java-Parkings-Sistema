 ...
 * @author Joao
 */
public class EstacionarVeiculo extends javax.swing.JDialog {

    /**
     * Creates new form EstacionarVeículo
     */
    public EstacionarVeiculo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EstacionarVeiculo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EstacionarVeiculo dialog = new EstacionarVeiculo(new javax.swing.JFrame(), true);
